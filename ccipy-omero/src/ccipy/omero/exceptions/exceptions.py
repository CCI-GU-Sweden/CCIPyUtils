...
class OmeroException(Exception):
...
class OmeroConnectionError(OmeroException):
...
class ImageNotSupported(OmeroException):
...
class GeneralError(OmeroException):
...
class DuplicateFileExists(OmeroException):
...
class MetaDataError(OmeroException):
...
class OmeroObjectNotFoundError(OmeroException):
